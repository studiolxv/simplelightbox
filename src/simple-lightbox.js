    ...
    addEvents() {
        ...
        if (this.options.scrollZoom) {
            ...
            this.addEventListener(this.domNodes.image, ['mousewheel','DOMMouseScroll'], (event) => {
                ...
                this.zoomPanElement(parseFloat(this.controlCoordinates.targetOffsetX).toFixed(4) + "px", parseFloat(this.controlCoordinates.targetOffsetY).toFixed(4) + "px", parseFloat(this.controlCoordinates.targetScale).toFixed(4));
